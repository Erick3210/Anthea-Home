...
export class ZohoService {
  ...
  private zohoFormUrl =
    'https://forms.zohopublic.com/rubamx/form/NewLandingSaltillo/formperma/5TdyK-HqK3sXUDLumJNcolz1ItEGyJkDkSP6KDJF9mY/htmlRecords/submit';
  ...
  public validateForm(
    ...
    if (
      camposRequeridos.find((e) => e === 'Email') &&
    ...
    if (
      camposRequeridos.find((e) => e === 'PhoneNumber1_countrycode') &&
